...
required = {
    ...
    "high-resolution diff API synced": "detectArtworkInField(l,r,hiTr,localL,localR,lbg,rbg,target)" in geom and "detectArtworkInField(l,r,0,0" not in geom and "\\n            MaskResult hi=" not in geom,
