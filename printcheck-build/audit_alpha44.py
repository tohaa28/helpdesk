...
checks={
 ...
 'success tone':'static final int SUCCESS' in u,
 'warning tone':'static final int WARNING' in u,
 'error tone':'static final int ERROR' in u,
 'manual tone':'static final int MANUAL' in u,
 ...
 'report failure styled':'Не удалось показать результат' in rv,
 ...
 'image open toast styled':'Не удалось открыть изображение' in rv,
}
